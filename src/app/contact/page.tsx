                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 text-lg">(805) 893-2115</p>
                        <p className="text-gray-600 mt-1">
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <h3 className="text-xl font-semibold text-gray-900">Graduate Students</h3>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <h3 className="text-xl font-semibold text-gray-900">Postdoctoral Researchers</h3>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <h3 className="text-xl font-semibold text-gray-900">Visiting Researchers</h3>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 leading-relaxed mb-4">
