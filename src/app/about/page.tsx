      ...
      <section className="py-16 lg:py-24">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">Global Impact</h3>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 dark:text-gray-200 leading-relaxed mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Dryland Ecohydrology</h3>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 dark:text-gray-200 leading-relaxed">
            ...
            <Card className="group hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Environmental Sensing</h3>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 dark:text-gray-200 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Primary Affiliations</h3>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Collaborations</h3>
                <p className="text-gray-600 dark:text-gray-200 leading-relaxed">
