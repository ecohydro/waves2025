...
export default async function PersonDetail({ params }: PersonDetailProps) {
  ...
  const getUserGroupLabel = (userGroup: string) => {
    switch (userGroup) {
      ...
      case 'visitor': return 'Visiting Researcher';
      default: return userGroup;
    }
  };
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap gap-2 items-center mb-4">
                  <span className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${getUserGroupColor(person.userGroup)}`}>
                  ...
                  <CardContent className="p-6">
                    ...
                    <dl className="space-y-3">
                      <div>
                        ...
                        <dd className="text-sm text-gray-900">{getUserGroupLabel(person.userGroup)}</dd>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {person.socialMedia.researchGate && (
                          ...
                          >
                            ...
                            <span className="text-sm text-gray-700 group-hover:text-gray-900">ResearchGate</span>
                          </a>
                        )}
                      </div>
                    </CardContent>
