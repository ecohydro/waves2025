            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap gap-2 items-center mb-4">
                  ...
                  {!person.isActive && (
                    <span className="inline-flex px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-600 dark:text-gray-200">
                      Inactive
                    </span>
                  )}
                </div>

                <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">{person.name}</h1>

                {person.title && <p className="text-xl text-gray-600 dark:text-gray-200 mb-4">{person.title}</p>}
                    ...
                    <dl className="space-y-3">
                      ...
                      {person.joinDate && (
                        <div>
                          ...
                          <dd className="text-sm text-gray-900 dark:text-white">{formatDate(person.joinDate)}</dd>
                        </div>
                      )}
                      ...
                      {person.leaveDate && (
                        <div>
                          ...
                          <dd className="text-sm text-gray-900 dark:text-white">{formatDate(person.leaveDate)}</dd>
                        </div>
                      )}
                      ...
                      {person.currentPosition && (
                        <div>
                          ...
                          <dd className="text-sm text-gray-900 dark:text-white">{person.currentPosition}</dd>
                        </div>
                      )}
                    </dl>
                  </CardContent>
