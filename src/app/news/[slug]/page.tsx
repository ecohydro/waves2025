      ...
      <section className="py-16 bg-white dark:bg-slate-950">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-2 items-center mb-6">
            <span
              className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${getCategoryColor(article.category)}`}
            >
                        ...
                        >
                          ...
                          {(image.caption || image.credit) && (
                            <div className="absolute bottom-0 left-0 right-0 bg-black/70 text-white p-2">
                              {image.caption && <p className="text-xs">{image.caption}</p>}
                              {image.credit && (
                    ...
                    <div className="space-y-3">
                      {article.relatedProjects.map((project) => (
                        <div key={project._id}>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Status: {project.status}</p>
                        </div>
                      ))}
                    </div>
                  </CardContent>
      ...
      <section className="py-16 bg-wavesBlue">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
            Don't miss our latest research updates, publications, and lab news. Explore more
            articles and connect with our research team.
          </p>
