            ...
            <div>
              ...
              <div className="space-y-6">
                {newsItems.length > 0 ? (
                  ...
                  <p className="text-gray-600 dark:text-gray-200">No recent news available.</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                {publications.length > 0 ? (
                  ...
                  <p className="text-gray-600 dark:text-gray-200">No recent publications available.</p>
                )}
              </div>
            </div>
          </div>
