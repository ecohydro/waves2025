          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Food Security</h3>
                <p className="text-gray-600 dark:text-gray-200 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Land Use Change</h3>
                <p className="text-gray-600 dark:text-gray-200 text-sm leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Kenya</h3>
                <p className="text-gray-600 dark:text-gray-200 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Zambia</h3>
                <p className="text-gray-600 dark:text-gray-200 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Ghana</h3>
                <p className="text-gray-600 dark:text-gray-200 text-sm leading-relaxed">
