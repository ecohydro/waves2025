          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">Remote Sensing</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">Sensor Networks</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">IoT Systems</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">Open-Source Software</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">Machine Learning</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-3">Data Integration</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-50 mb-4">Arable Crop Intelligence Systems</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-gray-50 mb-2">Multi-Modal Sensing</h4>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <Card className="border-0 shadow-lg md:order-2">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-gray-50 mb-2">Autonomous Robotics</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="md:order-1">
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-50 mb-4">Fluxbot: Automated Soil Carbon Flux Measurement</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-50 mb-4">Unmanned Aerial Vehicle (UAV) Remote Sensing</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 dark:text-gray-50 mb-2">Multi-Scale Integration</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
