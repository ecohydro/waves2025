    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 lg:py-24">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6">Our Research</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Field-Based</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Technology-Driven</h3>
              <p className="text-gray-600 dark:text-gray-200 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Impact-Oriented</h3>
              <p className="text-gray-600 dark:text-gray-200 text-sm">
      ...
      <section className="py-16 lg:py-24 bg-gray-50 dark:bg-slate-900">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-6">Research Themes</h2>
          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Key Research Areas:</h4>
