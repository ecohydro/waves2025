      ...
      <section className="bg-white dark:bg-slate-950 border-b">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-2xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">Search</h1>
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {!hasSearched && !loading && (
            <div className="max-w-2xl mx-auto text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">Search our content</h3>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        {getResultDisplayText(result) && (
                          <p className="text-gray-600 dark:text-gray-200 line-clamp-3">
                            {getResultDisplayText(result)}
                          </p>
                        )}
                      </div>
