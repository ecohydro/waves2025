        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-3 text-wavesLightBlue" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:caylor@ucsb.edu" className="hover:text-wavesLightBlue transition-colors">
                  caylor@ucsb.edu
                </a>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/people" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Our Team
                </Link>
              </li>
              <li>
                <Link href="/publications" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Publications
                </Link>
              </li>
              <li>
                <Link href="/projects" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Research Projects
                </Link>
              </li>
              <li>
                <Link href="/news" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  News & Updates
                </Link>
              </li>
              <li>
                <Link href="/opportunities" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Opportunities
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/research/ecohydrology" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Ecohydrology
                </Link>
              </li>
              <li>
                <Link href="/research/agriculture" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Agricultural Systems
                </Link>
              </li>
              <li>
                <Link href="/research/environmental-sensing" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Environmental Sensing
                </Link>
              </li>
              <li>
                <Link href="/research/climate-resilience" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Climate Resilience
                </Link>
              </li>
              <li>
                <Link href="/research/water-resources" className="text-gray-300 hover:text-wavesLightBlue transition-colors">
                  Water Resources
                </Link>
              </li>
            </ul>
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <div className="mb-4 md:mb-0">
              <p>
                © {currentYear} WAVES Research Lab. All rights reserved.
              </p>
            </div>
